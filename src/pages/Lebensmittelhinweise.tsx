...
const Lebensmittelhinweise = () => {
  return (
    <>
      <SEO 
        title="Lebensmittelinformationen & Allergene"
        description="Allergen- und Lebensmittelinformationen von STORIA München gemäß EU-LMIV: Alle 14 Hauptallergene auf einen Blick."
        noIndex={true}
      />
