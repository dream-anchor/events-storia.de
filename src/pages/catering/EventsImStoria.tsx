          ...
          <div className="absolute inset-0 flex items-center justify-center px-4">
            <div className="text-center max-w-4xl backdrop-blur-md bg-black/30 rounded-2xl border border-white/10 px-8 py-10 md:px-12 md:py-14">
              ...
              <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto mb-8">
                {language === 'de'
                  ? "Authentische italienische Küche · Bis zu 300 Gäste Innen & Außen · Nähe Königsplatz & Pinakothek"
                  : "Authentic Italian Cuisine · Up to 300 Guests Indoors & Outdoors · Near Königsplatz & Pinakothek"}
              </p>
              <Button 
                size="lg" 
