...
const AGBRestaurant = () => {
  return (
    <>
      <SEO 
        title="AGB Restaurant & Reservierungen"
        description="AGB für Restaurantbesuche & Reservierungen bei STORIA München: Buchungsbedingungen, Stornierung und Hausregeln."
        noIndex={true}
      />
