...
const COPY = {
  de: {
    ...
    submittedPlaceholder:
      "Diese Anfrage wurde bereits an STORIA übermittelt.",
    chatLabel: "KI-Hinweise",
    attachmentsLabel: "Anhänge (optional)",
    summaryLabel: "Übersicht",
    ctaPrepare: "Anfrage vorbereiten",
    ctaReady: "Anfrage unverbindlich an STORIA senden",
    ctaAwaiting: "Ja, Anfrage jetzt senden",
    ctaSubmitting: "Wird übermittelt …",
    ctaSubmitted: "Anfrage an STORIA übermittelt ✓",
    ctaRetry: "Erneut senden",
    submitDisabledHintPrefix: "Dafür fehlen noch:",
    submitEnabledHint:
      "Kein verbindliches Angebot. STORIA prüft Ihre Anfrage persönlich.",
    awaitingHint: "Die KI hat um Bestätigung gebeten.",
    submittedHint:
      "STORIA prüft Ihre Anfrage persönlich und meldet sich mit einem verbindlichen Angebot.",
  ...
  en: {
    ...
    composerHint:
      "\"Send message\" only sends a chat question. \"Send request to STORIA\" submits your inquiry.",
    composerHintShort: "Ask a question or submit a request.",
    introHint:
    ...
    submittedPlaceholder:
      "This request has already been submitted to STORIA.",
    chatLabel: "AI hints",
    attachmentsLabel: "Attachments (optional)",
    summaryLabel: "Summary",
    ctaPrepare: "Prepare request",
    ctaReady: "Send non-binding request to STORIA",
    ctaAwaiting: "Yes, send request now",
    ctaSubmitting: "Submitting …",
    ctaSubmitted: "Request sent to STORIA ✓",
    ctaRetry: "Try again",
    submitDisabledHintPrefix: "Still missing:",
    submitEnabledHint:
      "Not a binding offer. STORIA will review your request personally.",
    awaitingHint: "The AI has asked for your confirmation.",
    submittedHint:
      "STORIA will review your request personally and follow up with a binding offer.",
    close: "Close panel",
    minimize: "Minimize",
