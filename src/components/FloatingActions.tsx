...
const FloatingActions = () => {
  ...
  return (
    <div className="fixed bottom-[max(1.5rem,env(safe-area-inset-bottom,1.5rem))] right-6 z-50 flex flex-col gap-3 animate-fade-in">
      {/* Telefon Button */}
      {isMobile ? (
        <a
      ...
      {/* WhatsApp Button */}
      <a
        href="https://wa.me/491636033912?text=Hallo%2C%20ich%20plane%20ein%20Event%20und%20habe%20eine%20Anfrage%20an%20das%20STORIA.%20Vielen%20Dank!"
        target="_blank"
