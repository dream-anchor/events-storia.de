      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 p-4">
        <div className="bg-card border border-border rounded-lg shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="px-4 pb-4 text-center">
            <LocalizedLink to="legal.cookies" className="text-xs text-muted-foreground hover:text-foreground underline">
              {t.cookies.moreInfo}
            </LocalizedLink>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto bg-card border border-border rounded-lg shadow-2xl">
        <div className="p-4 md:p-6">
          ...
          <div className="mt-3 text-center">
            <LocalizedLink to="legal.privacy" className="text-xs text-muted-foreground hover:text-foreground underline mr-3">
              {t.footer.privacy}
            </LocalizedLink>
            <LocalizedLink to="legal.cookies" className="text-xs text-muted-foreground hover:text-foreground underline">
              {t.cookies.moreInfo}
