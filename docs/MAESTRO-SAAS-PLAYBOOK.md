...
| Preis-/Modul-Tarifstufen | B10/B12 | ✅ ENTSCHIEDEN (Nutzer, 2026-07-05): **Hybrid-Modell** statt reiner Umsatzbeteiligung (Fresha/OpenTable-Evidenz dagegen). Launch-Gerüst: FREE 0 € (5 Angebote/Mon, MAESTRO-Branding, 1,5 % Plattform-Fee auf Online-Zahlungen via Stripe application_fee, Cap 90 €/Event) · PRO 79 €/Mon Launch → Ziel 99 € (unlimitiert, KI voll, Fee 0,8 %, Cap 49 €/Mon) · TEAM 149 €/Mon (Multi-Nutzer/Standort, Fee 0,4 %, Module à 19–29 €). Invers sinkende, gedeckelte Fee = „zahlst mehr wenn du verdienst", messbar nur dort wo es fair ist. Exakte Zahlen vor Launch validieren (Zahlungsbereitschafts-Test, Stripe-DACH-Konditionen, AGB anwaltlich). |
...
| Marktplatz-Strategie | B11+ | ✅ ENTSCHIEDEN (Nutzer, 2026-07-05): **Sequenz statt Sofort-Marktplatz** (Caterwings/Lemoncat/miomente-Evidenz). Phase 1 jetzt: öffentliche Profilseite + Anfrage-Widget je Mandant (im Abo). Phase 2 ab ~10–15 Mandanten/Stadt: Overflow-Routing abgelehnter Anfragen (kostenlos, mit Kunden-Einwilligung, DSGVO klären). Phase 3 erst ab 30–50 aktiven Betrieben/Stadt: Verzeichnis, 5–10 % NUR auf gewonnene Buchungen, Opt-in, nie Pay-per-Lead; Storia-Neutralität offenlegen. Trigger nicht erreicht → Phase 3 entfällt ersatzlos. |
