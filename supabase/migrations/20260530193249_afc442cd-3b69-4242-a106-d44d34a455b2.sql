-- Add customer_language to v2_events
ALTER TABLE public.v2_events
  ADD COLUMN IF NOT EXISTS customer_language text NOT NULL DEFAULT 'de'
    CHECK (customer_language IN ('de','en','it','fr'));

-- Update get_public_offer to include customer_language
