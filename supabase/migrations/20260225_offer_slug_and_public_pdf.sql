-- offer_slug: Hübsche URL für öffentliche Angebotsseite
-- Format: "max-mustermann-a851" (slugified name + 4-Zeichen UUID-Prefix)
...
-- RPC: Angebot per Slug laden (für /ihr-angebot/:slug Route)
...
-- get_public_offer erweitern: lexoffice_invoice_id + offer_slug mitgeben
...
BEGIN
  SELECT json_build_object(
    'inquiry', json_build_object(
      ...
      'lexoffice_document_type', ei.lexoffice_document_type,
